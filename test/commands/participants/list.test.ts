...
const { default: ParticipantsList } = await import('../../../src/commands/participants/list.js');
...
describe('participants list', () => {
  test('GETs /cases/{id}/participants and emits the response', async () => {
    mockOAuthSuccess('https://pega.example.com');
    nock('https://pega.example.com')
      .get('/prweb/api/application/v2/cases/MYAPP-CASE-1/participants')
      .reply(200, [{ role: 'Owner', user: 'U1' }]);

    captured = captureOutput();
    await ParticipantsList.run(['MYAPP-CASE-1']);
