...
const { default: ParticipantsGet } = await import('../../../src/commands/participants/get.js');
...
describe('participants get', () => {
  test('GETs /cases/{id}/participants/{role} and emits the response', async () => {
    mockOAuthSuccess('https://pega.example.com');
    nock('https://pega.example.com')
      .get('/prweb/api/application/v2/cases/MYAPP-CASE-1/participants/Owner')
      .reply(200, { role: 'Owner', user: 'U1' });
