...
export default class AssignmentsRefreshAction extends BaseCommand {
  static override description = 'Refresh field values for a specific action on an assignment';
  static override examples = [
    '<%= config.bin %> assignments refresh-action ASSIGN-1 --action Submit',
    '<%= config.bin %> assignments refresh-action ASSIGN-1 --action Submit --data @form.json',
  ];
