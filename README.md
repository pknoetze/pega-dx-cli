...
`pega-dx-cli` v1.0.0 covers the **Pega DX API v25.1.2** (Constellation). The complete endpoint → command mapping lives in [reference/api-coverage.md](reference/api-coverage.md), regenerated by `npm run audit:endpoints`. If you find a missing or drifted endpoint, please open an issue.
